...
import {EditFishes} from "@components/facility-form/fields/EditFishes.tsx";
import {EditOrganizations} from "@components/facility-form/fields/EditOrganizations.tsx";
...
import {ExistingFacilityActions} from "@components/facility-form/modes/edit/ExistingFacilityActions.tsx";
...
export const FacilityForm: FC<FacilityFormProps> = (props) => {
    ...
    const {data: facility = null, isLoading, isError, mode} = props;
    ...
    const submitNew = async (values: FacilityFormValues) => {
        try {
            setSubmitFailed(false);
            const created = await api.addNewFacility(values);
    ...
    const submitExisting = async (values: FacilityFormValues) => {
